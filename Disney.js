...
const DEFAULT_OPTIONS = {
  title: '𝗦𝘁𝗿𝗲𝗮𝗺𝗶𝗻𝗴 𝗗𝗶𝘀𝗻𝗲𝘆+  解锁检测',
  availableContent: '支持解锁 𝗗𝗶𝘀𝗻𝗲𝘆+ ➟ #REGION_FLAG# #REGION_NAME#',
  availableIcon: 'd.circle.fill',
  availableIconColor:'#00008B',
  availableStyle: 'good',
